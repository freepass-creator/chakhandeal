...
export async function listAllRisks() {
  ...
  return rows.map((r) => {
    const {
      ...
      subjectUserId, matchKey, piiRef, phone_lookup_token, evidence,
      ...rest
    } = r;
    void name; void birth; void phone; void license; void reason;
    void subjectUserId; void matchKey; void piiRef; void phone_lookup_token; void evidence;
    return {
      ...rest,
      id: r.id,
      type: r.type,
