        ...
        {DEMO_MODE && (
          <>
            ...
            <div className="demo-chips">
              {DEMO_LOGINS.map((d) => (
                <button key={d.email} type="button" className="demo-chip safe" disabled={busy}
                  onClick={() => { setEmail(d.email); setPw(d.password); doLogin(d.email, d.password); }}>
                  {d.label}
                </button>
              ))}
            </div>
